...
**Last Session Summary:** Moved the co-op human-psychic preview target percentage into the dial’s lower readout slot so the hidden target uses the same location as the guess percentage instead of duplicating above the dial.
